...
// 2개씩 묶고, 2개의 합이 다른 원소의 값과 더해서 0이면 answer++; 하면 되는줄 알았으나
// 삼중 for문을 통해서, 세자리 총 합이 0인 경우를 구하면 되는거였음
// algorithm의 next_permutation을 통해서 순열과 조합 구할 수 있다는걸 알았음
// 오름차순으로 정렬된거 순열로 배열 조합 나타내줌
